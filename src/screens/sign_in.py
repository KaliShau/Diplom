...
"")
        ...
        self.title.setGeometry(QtCore.QRect(490, 10, 81, 41))
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.signInButton.setGeometry(QtCore.QRect(480, 300, 101, 41))
        font = QtGui.QFont()
...
"}")
        ...
        self.passwodLabel.setGeometry(QtCore.QRect(390, 210, 61, 21))
        font = QtGui.QFont()
        font.setBold(False)
        ...
        self.passwordEdit.setGeometry(QtCore.QRect(390, 230, 301, 31))
        self.passwordEdit.setStyleSheet("")
        self.passwordEdit.setObjectName("passwordEdit")
        self.errorLabel = QtWidgets.QLabel(parent=self.layout)
        self.errorLabel.setGeometry(QtCore.QRect(390, 370, 301, 71))
        font = QtGui.QFont()
        font.setBold(False)
    ...
    def retranslateUi(self):
        ...
        self.title.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Вход</span></p><p><span style=\" font-size:24pt;\"><br/></span></p></body></html>"))
        ...
        self.signInButton.setText(_translate("Form", "Войти"))
